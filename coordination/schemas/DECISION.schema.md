# DECISION.schema — coordination/decisions/<task-id>.DECISION.md
...
decided_at: 2026-06-13              # required
```
...
4. `APPROVED` ⇒ `resulting_status=HANDOFF_TO_MSO`: la tarea entra al flujo soberano normal. **La decisión NO ejecuta**; solo autoriza que MSO/Police evalúen y ejecuten si corresponde.
